export default function Footer() {
  return (
    <footer className="bg-[var(--color-primary-softer)] text-white mt-20">
      <div
        className="
      ...
      >
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm md:text-base text-white/70">
            <li>
              <span className="text-[var(--color-accent)] font-semibold">Email:</span><br />
              dispatch@easydlogistics.com
            </li>
            <li>
              <span className="text-[var(--color-accent)] font-semibold">Phone:</span><br />
              (555) 123-4567
            </li>
            <li>
              <span className="text-[var(--color-accent)] font-semibold">Hours:</span><br />
