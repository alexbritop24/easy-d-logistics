        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-14">
          ...
          <div>
            ...
            <p className="mt-5 text-sm md:text-base text-white/68 leading-relaxed font-medium max-w-sm">
              Professional dispatching, DOT & MC compliance support for owner-operators and small fleets.
              We keep your wheels turning, compliant, and earnings growing.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm md:text-base text-white/68 font-medium">
              ...
              <li>
                <a href="/dot-compliance" className="hover:text-[var(--color-accent)] transition">
                  DOT & MC Compliance
                </a>
              </li>
              <li>
